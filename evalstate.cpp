...
void EvalState::setCurrentLine(int lineNumber) { //Sets the current line of the program to the given line number
    currentLine = lineNumber;
}

int EvalState::getCurrentLine() { //Returns the current line of the program
   return currentLine;
}
